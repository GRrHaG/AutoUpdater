...
GRRHAG_AUTOUPDATER_VERSION="1.01"
...
url_git_autoupdater=//api.github.com/repos/GRrHaG/Freqtrade_Strategy_AutoUpdater/releases/latest
...
LATEST_AUTOUPDATER_PATH=${DOWNLOAD_STRATEGY_PATH}"/AutoUpdater-"${latest_version_autoupdater}
